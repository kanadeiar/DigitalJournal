        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoclaveNumber = table.Column<int>(type: "int", nullable: false),
                    TimeStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AutoclavedTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    Factory1ProductTypeId = table.Column<int>(type: "int", nullable: false),
                    AutoclavedCount = table.Column<int>(type: "int", nullable: false),
                    Factory1ShiftId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Loose1RawValue = table.Column<double>(type: "float", nullable: false),
                    Loose2RawValue = table.Column<double>(type: "float", nullable: false),
                    Loose3RawValue = table.Column<double>(type: "float", nullable: false),
                    AutoclaveNumber = table.Column<int>(type: "int", nullable: false),
                    Factory1PackProductTypeId = table.Column<int>(type: "int", nullable: false),
                    PackProductCount = table.Column<int>(type: "int", nullable: false),
                    Factory1ShiftId = table.Column<int>(type: "int", nullable: false),
                    ProfileId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Tank1LooseRawValue = table.Column<double>(type: "float", nullable: false),
                    Tank2LooseRawValue = table.Column<double>(type: "float", nullable: false),
                    Tank3LooseRawValue = table.Column<double>(type: "float", nullable: false),
                    Factory1ShiftId = table.Column<int>(type: "int", nullable: false),
                    ProfileId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Place1ProductTypeId = table.Column<int>(type: "int", nullable: false),
                    Place1ProductsCount = table.Column<int>(type: "int", nullable: false),
                    Place2ProductTypeId = table.Column<int>(type: "int", nullable: false),
                    Place2ProductsCount = table.Column<int>(type: "int", nullable: false),
                    Place3ProductTypeId = table.Column<int>(type: "int", nullable: false),
                    Place3ProductsCount = table.Column<int>(type: "int", nullable: false),
                    Factory1ShiftId = table.Column<int>(type: "int", nullable: false),
                    ProfileId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
