        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Place1ProductsValue = table.Column<double>(type: "REAL", nullable: false),
                    Place2ProductTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    Place2ProductsValue = table.Column<double>(type: "REAL", nullable: false),
                    Place3ProductTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    Place3ProductsValue = table.Column<double>(type: "REAL", nullable: false),
                    Factory1ShiftId = table.Column<int>(type: "INTEGER", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    Timestamp = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true)
                },
